...
#if PLATFORM_MAC
#include "ThirdParty/OpenSSL/1.1.1/Mac/openssl/err.h"
#include "ThirdParty/OpenSSL/1.1.1/Mac/openssl/md5.h"
#include "ThirdParty/OpenSSL/1.1.1/Mac/openssl/ssl.h"
#include "ThirdParty/OpenSSL/1.1.1/Mac/openssl/x509v3.h"
#elif PLATFORM_LINUX
#include "ThirdParty/OpenSSL/1.1.1c/include/Linux/x86_64-unknown-linux-gnu/openssl/err.h"
#include "ThirdParty/OpenSSL/1.1.1c/include/Linux/x86_64-unknown-linux-gnu/openssl/md5.h"
#include "ThirdParty/OpenSSL/1.1.1c/include/Linux/x86_64-unknown-linux-gnu/openssl/ssl.h"
#include "ThirdParty/OpenSSL/1.1.1c/include/Linux/x86_64-unknown-linux-gnu/openssl/x509v3.h"
#else
#include "ThirdParty/OpenSSL/1.1.1/Include/Win64/VS2015/openssl/err.h"
#include "ThirdParty/OpenSSL/1.1.1/Include/Win64/VS2015/openssl/md5.h"
#include "ThirdParty/OpenSSL/1.1.1/Include/Win64/VS2015/openssl/ssl.h"
#include "ThirdParty/OpenSSL/1.1.1/Include/Win64/VS2015/openssl/x509v3.h"
#endif
...
namespace httplib {
    ...
    struct Request {
        ...
        ContentProvider content_provider = nullptr;
    ...
    public:
        ...
        /* New functions for implementing ResponseHandler, ContentReceiver and Progress with Params support */
        Result Post(const char* path, const Headers& headers, const Params& params, size_t content_length, ContentProvider content_provider, const char* content_type);
        Result Post(const char* path, const Headers& headers, const Params& params, size_t content_length, ContentProvider content_provider, const char* content_type, ResponseHandler response_handler);
        Result Post(const char* path, const Headers& headers, const Params& params, size_t content_length, ContentProvider content_provider, const char* content_type, ContentReceiver content_receiver);
        Result Post(const char* path, const Headers& headers, const Params& params, size_t content_length, ContentProvider content_provider, const char* content_type, Progress progress);
        Result Post(const char* path, const Headers& headers, const Params& params, size_t content_length, ContentProvider content_provider, const char* content_type, ContentReceiver content_receiver, Progress progress);
        Result Post(const char* path, const Headers& headers, const Params& params, size_t content_length, ContentProvider content_provider, const char* content_type, ResponseHandler response_handler, ContentReceiver content_receiver, Progress progress);
        /* New functions end */
        ...
        /* New functions for implementing ResponseHandler, ContentReceiver and Progress with Params support */
        Result Put(const char* path, const Headers& headers, const Params& params, size_t content_length, ContentProvider content_provider, const char* content_type);
        Result Put(const char* path, const Headers& headers, const Params& params, size_t content_length, ContentProvider content_provider, const char* content_type, ResponseHandler response_handler);
        Result Put(const char* path, const Headers& headers, const Params& params, size_t content_length, ContentProvider content_provider, const char* content_type, ContentReceiver content_receiver);
        Result Put(const char* path, const Headers& headers, const Params& params, size_t content_length, ContentProvider content_provider, const char* content_type, Progress progress);
        Result Put(const char* path, const Headers& headers, const Params& params, size_t content_length, ContentProvider content_provider, const char* content_type, ContentReceiver content_receiver, Progress progress);
        Result Put(const char* path, const Headers& headers, const Params& params, size_t content_length, ContentProvider content_provider, const char* content_type, ResponseHandler response_handler, ContentReceiver content_receiver, Progress progress);
        /* New functions end */
        ...
        /* New functions for implementing ResponseHandler, ContentReceiver and Progress without Params support */
        Result Patch(const char* path, const Headers& headers, const Params& params, size_t content_length, ContentProvider content_provider, const char* content_type, ResponseHandler response_handler);
        Result Patch(const char* path, const Headers& headers, const Params& params, size_t content_length, ContentProvider content_provider, const char* content_type, ContentReceiver content_receiver);
        Result Patch(const char* path, const Headers& headers, const Params& params, size_t content_length, ContentProvider content_provider, const char* content_type, Progress progress);
        Result Patch(const char* path, const Headers& headers, const Params& params, size_t content_length, ContentProvider content_provider, const char* content_type, ContentReceiver content_receiver, Progress progress);
        Result Patch(const char* path, const Headers& headers, const Params& params, size_t content_length, ContentProvider content_provider, const char* content_type, ResponseHandler response_handler, ContentReceiver content_receiver, Progress progress);
        /* New functions end */
        ...
        /* New functions for implementing ResponseHandler, ContentReceiver and Progress without Params and ContentProvider support */
        Result Delete(const char* path, const Headers& headers, const char* content_type, ResponseHandler response_handler);
        Result Delete(const char* path, const Headers& headers, const char* content_type, ContentReceiver content_receiver);
        Result Delete(const char* path, const Headers& headers, const char* content_type, Progress progress);
        Result Delete(const char* path, const Headers& headers, const char* content_type, ContentReceiver content_receiver, Progress progress);
        Result Delete(const char* path, const Headers& headers, const char* content_type, ResponseHandler response_handler, ContentReceiver content_receiver, Progress progress);
        Result Delete(const char* path, const Headers& headers, const std::string& body, const char* content_type, ResponseHandler response_handler, ContentReceiver content_receiver, Progress progress);
        Result Delete(const char* path, const Headers& headers, ResponseHandler response_handler, ContentReceiver content_receiver, Progress progress);
        /* New functions end */
...
#define USE_IF2IP
        ...
        inline bool load_system_certs_on_windows(X509_STORE* store) {
            ...
            /* C++11 Fix
             * previous version is = while (pContext = CertEnumCertificatesInStore(hStore, pContext)) {
             * */
        ...
        if (req.content_provider) {
            ...
            data_sink.write = [&](const char* d, size_t l) {
                ...
                if (bChunked)
                {
					...
					std::string beforePayloadPart = detail::from_i_to_hex(l) + "\r\n";
					size_t chunkTotalSize = beforePayloadPart.size(); //size and r-n
					chunkTotalSize += l; //itself
					chunkTotalSize += 2; //r-n

					TArray<uint8> ChunkCompiled;
					ChunkCompiled.AddUninitialized(chunkTotalSize);
					FMemory::Memcpy(ChunkCompiled.GetData(), beforePayloadPart.c_str(), beforePayloadPart.size());
					FMemory::Memcpy(ChunkCompiled.GetData() + beforePayloadPart.size(), d, l);
					ChunkCompiled.GetData()[beforePayloadPart.size() + l] = '\r';
					ChunkCompiled.GetData()[beforePayloadPart.size() + l + 1] = '\n';

					if (!detail::write_data(strm, (const char*)ChunkCompiled.GetData(), chunkTotalSize)) {
						ok = false;
						return;
					}
                }
            ...
            data_sink.done = [&](void) 
            {
                ...
                {
					static const std::string done_marker("0\r\n\r\n");
					if (!detail::write_data(strm, done_marker.data(), done_marker.size())) {
						ok = false;
					}
                }
            };
    ...
    inline Result ClientImpl::Post(const char* path, const Headers& headers,
        ...
        auto ret = send_with_content_provider("POST", path, headers, body,
            content_length, content_provider,
            content_type, nullptr, nullptr, nullptr);
        return Result{ ret, get_last_error() };
    }
    ...
    inline Result ClientImpl::Post(const char* path, const Headers& headers,
        ...
        auto ret = send_with_content_provider("POST", path, headers, body,
            content_length, content_provider,
            content_type, response_handler, nullptr, nullptr);
        return Result{ ret, get_last_error() };
    }
    ...
    inline Result ClientImpl::Post(const char* path, const Headers& headers,
        ...
        auto ret = send_with_content_provider("POST", path, headers, body,
            content_length, content_provider,
            content_type, nullptr, content_receiver, nullptr);
        return Result{ ret, get_last_error() };
    }
    ...
    inline Result ClientImpl::Post(const char* path, const Headers& headers,
        ...
        auto ret = send_with_content_provider("POST", path, headers, body,
            content_length, content_provider,
            content_type, nullptr, nullptr, progress);
        return Result{ ret, get_last_error() };
    }
    ...
    inline Result ClientImpl::Post(const char* path, const Headers& headers,
        ...
        auto ret = send_with_content_provider("POST", path, headers, body,
            content_length, content_provider,
            content_type, nullptr, content_receiver, progress);
        return Result{ ret, get_last_error() };
    }
    ...
    inline Result ClientImpl::Post(const char* path, const Headers& headers,
        ...
        auto ret = send_with_content_provider("POST", path, headers, body,
            content_length, content_provider,
            content_type, response_handler, content_receiver, progress);
        return Result{ ret, get_last_error() };
    }
    ...
    inline Result ClientImpl::Put(const char* path, const Headers& headers,
        ...
        const char* content_type) {
        auto body = detail::params_to_query_str(params);
        auto ret = send_with_content_provider("PUT", path, headers, body,
            content_length, content_provider,
            content_type, nullptr, nullptr, nullptr);
        return Result{ ret, get_last_error() };
    }
    ...
    inline Result ClientImpl::Patch(const char* path, const Headers& headers,
        ...
        auto ret = send_with_content_provider("PATCH", path, headers, body, 0,
            nullptr, content_type, nullptr, nullptr, nullptr);
        return Result{ ret, get_last_error() };
    }
    ...
    inline Result ClientImpl::Patch(const char* path, const Headers& headers,
        ...
        ResponseHandler response_handler) {
        auto body = detail::params_to_query_str(params);
        auto ret = send_with_content_provider("PATCH", path, headers, body,
            content_length, content_provider,
            content_type, response_handler, nullptr, nullptr);
        return Result{ ret, get_last_error() };
    }
    ...
    inline Result ClientImpl::Delete(const char* path, const Headers& headers,
        const char* content_type,
        ResponseHandler response_handler) {
        return Delete(path, headers, std::string(), content_type, response_handler, nullptr, nullptr);
    }

    inline Result ClientImpl::Delete(const char* path, const Headers& headers,
        const char* content_type,
        ContentReceiver content_receiver) {
        return Delete(path, headers, std::string(), content_type, nullptr, content_receiver, nullptr);
    }

    inline Result ClientImpl::Delete(const char* path, const Headers& headers,
        const char* content_type,
        Progress progress) {
        return Delete(path, headers, std::string(), content_type, nullptr, nullptr, progress);
    }
    ...
    inline Result ClientImpl::Delete(const char* path, const Headers& headers,
        ...
        ContentReceiver content_receiver,
        Progress progress) {
        return Delete(path, headers, std::string(), content_type, nullptr, content_receiver, progress);
    }
    ...
    inline Result ClientImpl::Delete(const char* path, const Headers& headers,
        ...
        ContentReceiver content_receiver,
        Progress progress) {
        return Delete(path, headers, std::string(), content_type, response_handler, content_receiver, progress);
    }
    ...
    inline Result ClientImpl::Delete(const char* path, const Headers& headers,
        ...
        ContentReceiver content_receiver,
        Progress progress) {
        return Delete(path, headers, std::string(), nullptr, response_handler, content_receiver, progress);
    }
    ...
    inline Result Client::Post(const char* path, const Headers& headers,
        ...
        ContentProvider content_provider,
        const char* content_type) {
        return cli_->Post(path, headers, params, content_length, content_provider,
            content_type);
    }
    inline Result Client::Post(const char* path, const Headers& headers,
        const Params& params,
    ...
    inline Result Client::Post(const char* path, const Headers& headers,
        ...
        Progress progress) {
        return cli_->Post(path, headers, params, content_length, content_provider,
            content_type, content_receiver, progress);
    }
    inline Result Client::Post(const char* path, const Headers& headers,
        const Params& params,
        size_t content_length,
    ...
    inline Result Client::Put(const char* path, const Headers& headers,
        ...
        ContentProvider content_provider,
        const char* content_type) {
        return cli_->Put(path, headers, params, content_length, content_provider,
            content_type);
    }
    inline Result Client::Put(const char* path, const Headers& headers,
        const Params& params,
    ...
    inline Result Client::Patch(const char* path, const Headers& headers,
        ...
        const char* content_type,
        ResponseHandler response_handler) {
        return cli_->Patch(path, headers, params, content_length, content_provider,
            content_type, response_handler);
    }
    inline Result Client::Patch(const char* path, const Headers& headers,
        const Params& params, size_t content_length,
    ...
    inline Result Client::Delete(const char* path, const Headers& headers,
        const char* content_type,
        ResponseHandler response_handler) {
        return cli_->Delete(path, headers, content_type, response_handler);
    }
    inline Result Client::Delete(const char* path, const Headers& headers,
        const char* content_type,
        ContentReceiver content_receiver) {
        return cli_->Delete(path, headers, content_type, content_receiver);
    }
    inline Result Client::Delete(const char* path, const Headers& headers,
        const char* content_type,
        Progress progress) {
        return cli_->Delete(path, headers, content_type, progress);
    }
    inline Result Client::Delete(const char* path, const Headers& headers,
        const char* content_type,
        ContentReceiver content_receiver,
        Progress progress) {
        return cli_->Delete(path, headers, content_type, content_receiver, progress);
    }
    inline Result Client::Delete(const char* path, const Headers& headers,
        const char* content_type,
        ResponseHandler response_handler,
        ContentReceiver content_receiver,
        Progress progress) {
        return cli_->Delete(path, headers, std::string(), content_type, response_handler, content_receiver, progress);
    }
    inline Result Client::Delete(const char* path, const Headers& headers,
        const std::string& body,
        const char* content_type,
        ...
        ContentReceiver content_receiver,
        Progress progress) {
        return cli_->Delete(path, headers, body, content_type, response_handler, content_receiver, progress);
    }
    inline Result Client::Delete(const char* path, const Headers& headers,
        ResponseHandler response_handler,
        ContentReceiver content_receiver,
        Progress progress) {
        return cli_->Delete(path, headers, std::string(), nullptr, response_handler, content_receiver, progress);
    }
    /* New functions end  */
